...
package org.wso2.carbon.identity.claim.mgt.endpoint.util;
...
/**
 * Utility class containing various claim management implementation related functionality.
 */
public class ClaimMgtUtils {

    private ClaimMgtUtils() {
    }
    ...
    public static ClaimDialectDTO convertClaimDialectToClaimDialectDTO(ClaimDialect claimDialect) {
        ...
        claimDialectDTO.setId(claimDialect.getClaimDialectURI());
    ...
    public static ClaimDialect convertClaimDialectDTOToClaimDialect(ClaimDialectDTO claimDialectDTO) {
        ...
        ClaimDialect claimDialect = new ClaimDialect(claimDialectDTO.getId());
        return claimDialect;
    }
    ...
    public static LocalClaimDTO convertLocalClaimToLocalClaimDTO(LocalClaim localClaim) {
        ...
        localClaimDTO.setAttributeMappings(Arrays.asList(attributeMappingDTOs));
        ...
        localClaimDTO.setClaimProperties(Arrays.asList(claimPropertyDTOs));
    ...
    public static ExternalClaimDTO convertExternalClaimToExternalClaimDTO(ExternalClaim externalClaim) {
        ...
        //TODO: Check the inconsistency
        //externalClaimDTO.setExternalClaimDialectURI(externalClaim.getClaimDialectURI());

        externalClaimDTO.setExternalClaim(externalClaim.getClaimURI());
        externalClaimDTO.setMappedLocalClaim(externalClaim.getMappedLocalClaim());
    ...
    public static ExternalClaim convertExternalClaimDTOToExternalClaim(String dialectId, ExternalClaimDTO
            externalClaimDTO) {

        ExternalClaim externalClaim = new ExternalClaim(dialectId, externalClaimDTO.getExternalClaim(),
                externalClaimDTO.getMappedLocalClaim());
